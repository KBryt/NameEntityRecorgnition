...
class ProductClassifier(object):
    ...
    def compile(self, tokenizer, glove_dir='/content/', embedding_dim=100, dropout_fraction=0.0, kernal_size=5, n_filters=128):
    ...
    def train(self, data, labels, validation_split=0.2, batch_size=256, epochs=50):
        """Train classifier
        Args:
